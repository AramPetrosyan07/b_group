...
import Cart from '../../components/images/Cart Icon.svg'
import Headervector from '../../components/images/HeaderVector.svg';
        ...
        <body>
            <div className={Styles.Header}>
                ...
                <ul>
                    <li>Home</li>
                    <li>About</li>
                    <li className={Styles.MenuHover}><img src={Headervector} />Pages</li>
                    <li>Shop</li>
                    <li>Projects</li>
                    <li>News</li>
                </ul>
